export default function HomePage() {
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 py-16 text-center">
      <img src="/freespace-logo.png" alt="FreeSpace" className="h-24 w-auto mix-blend-multiply sm:h-28" />
      ...
      <p className="mt-3 max-w-lg text-base text-slate-600">
        We’re building a simpler122343z way to find and book parking. Check back soon.
      </p>
    </div>
  );
}
