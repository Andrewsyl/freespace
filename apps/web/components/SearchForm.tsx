            ...
            {state.mode === "monthly" ? (
              <div className="flex min-w-[302px] flex-col justify-center rounded-md border border-[#d5dbe3] bg-white px-4 py-2 text-left shadow-[0_1px_2px_rgba(15,23,42,0.08)]">
                ...
                <div className="relative mt-0.5">
                  ...
                  <ChevronDown className="pointer-events-none absolute right-0 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" strokeWidth={2} />
                </div>
              </div>
            ) : (
              <DateTimePicker
        ...
        {state.mode === "monthly" ? (
          <div className="grid grid-cols-2 gap-2">
            ...
            <label className="relative flex h-12 flex-col justify-center rounded-lg border border-[#E5E7EB] bg-white px-3 shadow-sm">
              ...
              <ChevronDown className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 text-slate-400" strokeWidth={2} />
            </label>
          </div>
        ) : (
          <div className="grid grid-cols-2 gap-2">
      ...
      <div className="relative" ref={containerRef}>
        ...
        >
          <div className="flex items-center justify-between gap-3">
            ...
            <ChevronDown className={`h-[18px] w-[18px] shrink-0 transition-transform ${open ? "rotate-180 text-[#202631]" : "text-[#202631]"}`} strokeWidth={2.2} />
          </div>
        </button>
        {popup}
      </div>
  ...
  return (
    <div className="relative" ref={containerRef}>
      ...
      >
        ...
        <ChevronDown className={`h-4 w-4 shrink-0 transition-transform ${open ? "rotate-180 text-brand-500" : "text-slate-400"}`} strokeWidth={2} />
      </button>
      {popup}
    </div>
  );
